...
class CameraApp(QtWidgets.QMainWindow):
    ...
    def setupUi(self, Widget):
        ...
        self.Apply_LED_pushButton.setGeometry(QtCore.QRect(122, 134, 191, 50))
        ...
        self.White_LED_plus_pushButton_2 = QtWidgets.QPushButton(self.page_3)
        self.White_LED_plus_pushButton_2.setGeometry(QtCore.QRect(338, 6, 50, 50))
        self.White_LED_plus_pushButton_2.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/switch.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.White_LED_plus_pushButton_2.setIcon(icon1)
        self.White_LED_plus_pushButton_2.setIconSize(QtCore.QSize(20, 20))
        self.White_LED_plus_pushButton_2.setCheckable(True)
        self.White_LED_plus_pushButton_2.setChecked(True)
        self.White_LED_plus_pushButton_2.setObjectName("White_LED_plus_pushButton_2")
        self.White_LED_plus_pushButton_3 = QtWidgets.QPushButton(self.page_3)
        self.White_LED_plus_pushButton_3.setGeometry(QtCore.QRect(338, 64, 50, 50))
        self.White_LED_plus_pushButton_3.setText("")
        self.White_LED_plus_pushButton_3.setIcon(icon1)
        self.White_LED_plus_pushButton_3.setIconSize(QtCore.QSize(20, 20))
        self.White_LED_plus_pushButton_3.setCheckable(True)
        self.White_LED_plus_pushButton_3.setChecked(True)
        self.White_LED_plus_pushButton_3.setObjectName("White_LED_plus_pushButton_3")
